...
def exibe_proveniencia(): 
    ...
    atividade = d0.activity('atividade: Excluir os dados em uma classe', other_attributes= {'atividade:Ambiente':'PROVChain',
    ...
    entidade  = d0.entity('entidade: Observacao', {'entidade:Descricao': 'Registrar metadados de exclusão',
                                                     'entidade:Localizacao':' PROVChain',
                                                     'entidade:Nome':'Observacao',
                                                     'entidade:Situação': 'Registro excluído',        
                                                     'entidade:ID': '239a5445-374d-455e-9b88-47c1dcd65b88q5c24',
                                             })

    # Adicionando Agentes
    agente = d0.agent('agente: Pesquisador', {'agente:Nome': 'Élton Carneiro Marinho',
    ...
    d0.wasAttributedTo(entidade, agente,    other_attributes= {'agente: Função':'Proceder a exclusão das informações'})
    
    # Adicionando as relacoes atividades com Agentes 
    d0.wasAssociatedWith(atividade, agente,           other_attributes= {'agente: Função ':'Efetuar exclusão do registro de observação'})
