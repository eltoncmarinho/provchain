...
def exibe_proveniencia(): 
    ...
    inclusao = d0.activity('atividade: Incluir de dados em uma classe', other_attributes= {'atividade:Ambiente':'PROVChain',
    ...
    observacao  = d0.entity('entidade: Observacao', {'entidade:Descricao': 'Armazena dados e metadados de proveniência',
